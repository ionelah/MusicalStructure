...
public class PlayingNow extends AppCompatActivity{
    ...
    protected void onCreate(Bundle saveInstanceState){
        ...
        if (getIntent().hasExtra("ARTIST_NAME")) {
            artistTextView.setText(getIntent().getStringExtra("ARTIST_NAME"));
        }
        ...
        if (getIntent().hasExtra("SONG_NAME")) {
            songTextView.setText(getIntent().getStringExtra("SONG_NAME"));
        }
        ...
        if (getIntent().hasExtra("SONG_TIME")) {
            timeTextView.setText(getIntent().getStringExtra("SONG_TIME"));
        }
    }
}
